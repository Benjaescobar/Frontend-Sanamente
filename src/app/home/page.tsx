...
function Options({title, content, href}) {
  return (
  <a href={href}>
    ...
    <div className="flex flex-col mt-12 text-center space-y-24">
      <div className="flex flex-col justify-between space-y-6 text-3xl"> 
        <div>
          ...
          <span className="text-lg">Puedes comenzar con alguna de las siguientes opciones:</span>
        </div>
        <div className="flex justify-center text-lg space-x-16">
          <Options 
            title="Agendar con un profesional:" 
            content="Busca directamente a un profesional que se adecúe a tus necesidades,
              y comienza tus sesiones de terapia."
            href="/search"
          />
          <Options 
            title="Navegar el feed de Posts profesionales:" 
            content="¿No sabes por dónde comenzar? comienza navegando los Posts que hacen los profesionales del sitio,
              para informarse y a conocer a algunos de los psicólogos."
            href="/feed"
          />
          <Options 
            title="Acudir a un grupo de ayuda:" 
            content="También puedes comenzar buscando un grupo de ayuda, donde puedes
      ...
      <div>
        ...
        <div className="flex justify-center space-x-10">
          <Reasons
            title="Nos adaptamos a tu bolsillo 💰"/>
          <Reasons
            title="Escoges a quien más te acomode 🙋🏼"/>
          <Reasons
            title="Agendas de manera rápida y cómoda 📕"/>
          <Reasons
            title="Chateas con quien quieras 💬"/>
        </div>
      </div>
      </div>
    </>
