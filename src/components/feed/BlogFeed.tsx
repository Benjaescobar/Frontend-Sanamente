...
const posts = [
  ...
  },
  {
    ...
    content:
      "Uno de los temas que más abordo en consulta es la importancia de establecer límites claros en nuestras relaciones. Muchas veces, las personas se sienten culpables o incómodas al decir 'no', \
